  ...
  return (
    ...
    <section className="py-24 px-4 sm:px-8 relative z-10 animate-fade-in-up max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        {/* Method 1 */}
        <a href="https://futuretonestudio.blogspot.com/2026/03/method-1-prompting.html" target="_blank" rel="noopener noreferrer" aria-label="Method 1: The Curator – opens in new tab" className="group p-8 border border-white/10 bg-zinc-900/50 hover:bg-zinc-900 transition-all duration-500 hover:border-purple-500/30 relative overflow-hidden block">
