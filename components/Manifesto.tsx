    ...
    <section className="py-24 px-4 bg-black/40 backdrop-blur-sm min-h-[60vh] flex items-center animate-fade-in-up">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <p className="text-2xl sm:text-4xl md:text-5xl font-light leading-tight text-white/90">
          "While others argue over black or white - pure human or pure AI - all or nothing - the future exists in the <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 font-bold">grey</span>. Hybrid production is the search for the soul inside the algorithm. In some form, this is the only way forward with the modern music industry."
        </p>
